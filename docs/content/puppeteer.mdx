---
title: "Puppeteer Firefox — Use Puppeteer with Firefox via Foxbridge CDP"
description: "Connect Puppeteer to Firefox and Camoufox using foxbridge. 74/74 Juggler tests and 62/62 BiDi tests passing."
---
