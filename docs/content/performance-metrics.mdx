---
title: "Performance Metrics — Page Timing Data from Firefox via CDP"
description: "Get real page performance timing data from Firefox using CDP Performance.getMetrics through foxbridge."
---
...
- [PDF Generation](/pdf-generation) — Generate PDFs from Firefox pages via CDP
