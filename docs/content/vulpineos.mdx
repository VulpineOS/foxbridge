...
Foxbridge is a core component of [VulpineOS](https://vulpineos.com) -- the AI agent security runtime. It bridges OpenClaw (and other CDP-speaking agents) to Camoufox, enabling anti-detect browsing without Chrome.
