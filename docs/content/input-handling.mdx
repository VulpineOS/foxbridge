---
title: "Input Handling — Mouse, Keyboard, and Touch Events in Firefox CDP"
description: "Dispatch mouse clicks, keyboard events, and touch gestures to Firefox pages using CDP Input domain via foxbridge."
---
...
- [Device Emulation](/emulation) — Viewport, geolocation, and user agent overrides
