---
title: "CDP Domain Coverage — 13 Fully Implemented Chrome DevTools Domains"
description: "Foxbridge implements 13 CDP domains: Target, Page, Runtime, Input, Network, Emulation, DOM, Fetch, Performance, Accessibility, IO, Console, Browser."
---

# CDP Domain Coverage — 13 Chrome DevTools Domains for Firefox

Full list of Chrome DevTools Protocol domains and methods implemented by foxbridge.

For the live coverage snapshot generated from the current bridge surface, run:

```bash
foxbridge doctor
```

Use the command output when you need exact implemented, stubbed, missing, and extension counts for the current build.
